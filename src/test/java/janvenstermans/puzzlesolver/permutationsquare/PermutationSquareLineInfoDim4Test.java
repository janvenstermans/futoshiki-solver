 ...
 */
public class PermutationSquareLineInfoDim4Test {
    ...
    public void testApplyChangeForEmptyLineWithEmptyArgument() throws Exception {
        ...
        possibleValueMap.put(0, Arrays.asList(1,2,3,4));
        possibleValueMap.put(1, Arrays.asList(1,2,3,4));
        possibleValueMap.put(2, Arrays.asList(1,2,3,4));
        possibleValueMap.put(3, Arrays.asList(1,2,3,4));
        Map<IntegerPermutationSquareValue, List<Integer>> indexPerValueMap = new HashMap<>();
        indexPerValueMap.put(PermutationSquareValueFactory.createIntegerPermutationSquareValue(1), Arrays.asList(0,1,2,3));
        indexPerValueMap.put(PermutationSquareValueFactory.createIntegerPermutationSquareValue(2), Arrays.asList(0,1,2,3));
        indexPerValueMap.put(PermutationSquareValueFactory.createIntegerPermutationSquareValue(3), Arrays.asList(0,1,2,3));
        indexPerValueMap.put(PermutationSquareValueFactory.createIntegerPermutationSquareValue(4), Arrays.asList(0,1,2,3));
    ...
    public void testApplyChangeForEmptyLineChangeListOneThenNoResultExpected() throws Exception {
        ...
        possibleValueMap.put(1, Arrays.asList(2,3,4));
        possibleValueMap.put(2, Arrays.asList(2,3,4));
        possibleValueMap.put(3, Arrays.asList(2,3,4));
        Map<IntegerPermutationSquareValue, List<Integer>> indexPerValueMap = new HashMap<>();
        indexPerValueMap.put(PermutationSquareValueFactory.createIntegerPermutationSquareValue(1), Arrays.asList(0));
        indexPerValueMap.put(PermutationSquareValueFactory.createIntegerPermutationSquareValue(2), Arrays.asList(1,2,3));
        indexPerValueMap.put(PermutationSquareValueFactory.createIntegerPermutationSquareValue(3), Arrays.asList(1,2,3));
        indexPerValueMap.put(PermutationSquareValueFactory.createIntegerPermutationSquareValue(4), Arrays.asList(1,2,3));
    ...
    @Test
    public void testApplyChangeForEmptyLineChangeListTwoThenNoResultExpected() throws Exception {
        PermutationSquareCellInfo<IntegerPermutationSquareValue>[] cellArray
                = PermutationSquareLineInfoTestUtil.createCellArrayForRow(DIMENSION, ROW_INDEX);
        PermutationSquareLineInfo lineInfo = new PermutationSquareLineInfo<IntegerPermutationSquareValue>(
                ROW_INDEX, LINE_TYPE, cellArray, PermutationSquareValueFactory.createIntegerListForDimension(DIMENSION));
        ...
        possibleValueMap.put(2, Arrays.asList(2,4));
        possibleValueMap.put(3, Arrays.asList(2,4));
        Map<IntegerPermutationSquareValue, List<Integer>> indexPerValueMap = new HashMap<>();
        indexPerValueMap.put(PermutationSquareValueFactory.createIntegerPermutationSquareValue(1), Arrays.asList(1));
        indexPerValueMap.put(PermutationSquareValueFactory.createIntegerPermutationSquareValue(2), Arrays.asList(2,3));
        indexPerValueMap.put(PermutationSquareValueFactory.createIntegerPermutationSquareValue(3), Arrays.asList(0));
        indexPerValueMap.put(PermutationSquareValueFactory.createIntegerPermutationSquareValue(4), Arrays.asList(2,3));
    ...
    @Test
    public void testApplyChangeForEmptyLineChangeListThreeThenOneResultExpected() throws Exception {
        PermutationSquareCellInfo<IntegerPermutationSquareValue>[] cellArray
                = PermutationSquareLineInfoTestUtil.createCellArrayForRow(DIMENSION, ROW_INDEX);
        PermutationSquareLineInfo lineInfo = new PermutationSquareLineInfo<IntegerPermutationSquareValue>(
                ROW_INDEX, LINE_TYPE, cellArray, PermutationSquareValueFactory.createIntegerListForDimension(DIMENSION));
        List<PermutationSquareCellInfo<IntegerPermutationSquareValue>> changeInfoList
                = PermutationSquareLineInfoTestUtil.createChangeInfoList(DIMENSION, new int[][] {{0, ROW_INDEX, 3},{1, ROW_INDEX, 1},{3, ROW_INDEX, 2}});
        PermutationSquareLineInfoTestUtil.copyChangeInfoToCellArray(changeInfoList, cellArray);
        Map<Integer, List<Integer>> possibleValueMap = new HashMap<>();
        possibleValueMap.put(0, Arrays.asList(3));
        possibleValueMap.put(1, Arrays.asList(1));
        possibleValueMap.put(2, Arrays.asList(4));
        possibleValueMap.put(3, Arrays.asList(2));
        Map<IntegerPermutationSquareValue, List<Integer>> indexPerValueMap = new HashMap<>();
        indexPerValueMap.put(PermutationSquareValueFactory.createIntegerPermutationSquareValue(1), Arrays.asList(1));
        indexPerValueMap.put(PermutationSquareValueFactory.createIntegerPermutationSquareValue(2), Arrays.asList(3));
        indexPerValueMap.put(PermutationSquareValueFactory.createIntegerPermutationSquareValue(3), Arrays.asList(0));
        indexPerValueMap.put(PermutationSquareValueFactory.createIntegerPermutationSquareValue(4), Arrays.asList(2));

        List<PermutationSquareCellInfo<PermutationSquareValue>> resultList = lineInfo.applyChange(changeInfoList);

        Assert.assertEquals(1, resultList.size());
        PermutationSquareLineInfoTestUtil.assertCellInfo(resultList.get(0), 2, ROW_INDEX, PermutationSquareValueFactory.createIntegerPermutationSquareValue(4));
        PermutationSquareLineInfoTestUtil.assertCellContainsValuesMap(cellArray, possibleValueMap);
        PermutationSquareLineInfoTestUtil.assertLineIndexValuesMap(lineInfo, indexPerValueMap);
    }
    ...
    @Test
    public void testApplyChangeForLineWithLimitedCouplesValuesResultExpected() throws Exception {
        PermutationSquareCellInfo<IntegerPermutationSquareValue>[] cellArray
                = PermutationSquareLineInfoTestUtil.createCellArrayForRow(DIMENSION, ROW_INDEX);
        PermutationSquareLineInfo lineInfo = new PermutationSquareLineInfo<IntegerPermutationSquareValue>(
                ROW_INDEX, LINE_TYPE, cellArray, PermutationSquareValueFactory.createIntegerListForDimension(DIMENSION));
        ...
        possibleIndexMapInput.put(3, Arrays.asList(2,3));
        possibleIndexMapInput.put(4, Arrays.asList(0,3));
        ...
        possibleValueMap.put(3, Arrays.asList(4));
        Map<IntegerPermutationSquareValue, List<Integer>> indexPerValueMap = new HashMap<>();
        indexPerValueMap.put(PermutationSquareValueFactory.createIntegerPermutationSquareValue(1), Arrays.asList(0));
        ...
        indexPerValueMap.put(PermutationSquareValueFactory.createIntegerPermutationSquareValue(4), Arrays.asList(3));
        ...
        PermutationSquareLineInfoTestUtil.assertCellInfo(resultList.get(2), 3, ROW_INDEX, PermutationSquareValueFactory.createIntegerPermutationSquareValue(4));
        PermutationSquareLineInfoTestUtil.assertCellContainsValuesMap(cellArray, possibleValueMap);
        PermutationSquareLineInfoTestUtil.assertLineIndexValuesMap(lineInfo, indexPerValueMap);
    }
    ...
    public void testApplyChangeForFilledLineWithKnownValueResultExpected() throws Exception {
        ...
        PermutationSquareLineInfoTestUtil.setCellIntegerValuesForRow(lineInfo, cellArray, new int[][] {{0,ROW_INDEX,1}});
        List<PermutationSquareCellInfo<IntegerPermutationSquareValue>> changeInfoList
                = PermutationSquareLineInfoTestUtil.createChangeInfoList(DIMENSION, new int[][] {{2, ROW_INDEX, 2},{3, ROW_INDEX, 4}});
        PermutationSquareLineInfoTestUtil.copyChangeInfoToCellArray(changeInfoList, cellArray);
        Map<Integer, List<Integer>> possibleValueMap = new HashMap<>();
        possibleValueMap.put(0, Arrays.asList(1));
